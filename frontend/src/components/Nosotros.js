...
import { faUsersLine, faShieldDog, faHandshake, faGift } from '@fortawesome/free-solid-svg-icons'; // Asegúrate de tener estos íconos instalados
  ...
  return (
    <div>
      ...
      <div className="content">
        <h1><FontAwesomeIcon icon={faUsersLine} /> Sobre Nosotros</h1>
        <p>
        ...
        <h2><FontAwesomeIcon icon={faShieldDog} /> Nuestra Misión</h2>
        <p>
        ...
        <h2><FontAwesomeIcon icon={faHandshake} /> Colabora con Nosotros</h2>
        <p>
        ...
        <h2><FontAwesomeIcon icon={faGift} /> Eventos y Actividades</h2>
        <p>
